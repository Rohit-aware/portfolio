...
import SmartTooltip, {
  type SkillNode,
  type FloatTooltip,
} from '@/features/skills/components/SmartTooltip'
  ...
  TIER_ORDER.forEach((tier, ringIdx) => {
    const skills = SKILLS_DATA.flatMap((g) =>
      g.skills
        ...
        .map((s) => ({ name: s.name, category: g.category as string })),
    )
      ...
      <div className="section-container">
        <RevealWrapper>
          <div className="text-center mb-10">
            ...
            <h2 id="skills-heading-c" className="heading-lg text-foreground">
              Skill Constellation
            </h2>
              ...
              >
                ...
                {TIER_ORDER.map((tier, i) => (
                  <circle
                    ...
                    r={RING_RADII[i]}
                    fill="none"
                    stroke={TIER_STYLE[tier].ringStroke}
                    strokeWidth="1"
                  ...
                  <div key={g.category} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 h-1.5 rounded-full bg-surface overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min((g.skills.length / 7) * 100, 100)}%`,
                        }}
                      />
                    </div>
