...
import { CONNECT_LINKS } from '../constants/connectLinks'

const ConnectLinksPanel: React.FC = memo(() => (
...
ConnectLinksPanel.displayName = 'ConnectLinksPanel'
export default ConnectLinksPanel
