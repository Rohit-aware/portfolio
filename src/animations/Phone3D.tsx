    ...
    const tick = (): void => {
      ...
      if (phone) {
        ...
        if (isHover.current) {
          ...
          phone.style.transform = `rotateX(${current.current.rx}deg) rotateY(${current.current.ry}deg)`
        } else {
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 4, marginTop: 2 }}>
              {[
                ...
                >
                  <div
                    style={{ width: 20, height: 6, background: bg, borderRadius: 3 }}
                  />
                  <div
                    style={{
                      width: 28,
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div
                    style={{
                      width: `${55 + i * 8}%`,
                      height: 4,
                      background: `hsl(var(--foreground)/${op * 0.2})`,
                      borderRadius: 2,
                      marginBottom: 3,
                    }}
                  />
                  <div
                    style={{
                      width: `${35 + i * 5}%`,
                      height: 3,
                      background: `hsl(var(--muted-foreground)/${op * 0.2})`,
                      borderRadius: 2,
                    }}
                  />
                </div>
                <div
                  style={{
                    ...
                    height: 8,
                    borderRadius: '50%',
                    background: `hsl(var(--primary)/${op * 0.5})`,
                  }}
                />
              </div>
            ))}
